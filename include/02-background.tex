...
\begin{figure}[h]
 ...
 \label{fig:2.11}
\end{figure}
The Artificial Neural Networks are very versatile and have numerous applications. Based on their application, they are classified into various categories. According to \citet{klerfors1998artificial},  most applications of neural networks fall into the following five categories:\\
\begin{itemize}
\item Prediction
\item Classification
\item Recognition
